...
const de = {
  ...
  booking: {
    ...
    placementHint: "Beschreib die Stelle möglichst genau – ein Foto hilft uns zusätzlich.",
    photoLabel: "Foto der Stelle (optional)",
    photoHint: "JPG oder PNG, max. 5 MB. Nur für uns sichtbar.",
    photoChoose: "Foto auswählen",
    photoRemove: "Entfernen",
    photoTooLarge: "Das Foto ist zu groß (max. 5 MB).",
    photoInvalid: "Bitte ein Bild auswählen.",
...
const en: typeof de = {
  ...
  booking: {
    ...
    title: "Your appointment in 3 steps",
    text: "So we can reply fast, we only need a few details — just like the studio questionnaire.",
    stepLabel: "Step",
    of: "of",
    next: "Next",
    back: "Back",
    steps: [
      { title: "Availability", hint: "Which weekdays work for you?" },
      { title: "Tattoo idea", hint: "Describe your idea or send us inspiration." },
      { title: "Placement", hint: "Where exactly should the tattoo go?" },
    ],
    days: ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat"],
    daysLabel: "Weekdays",
    daysRequired: "Please pick at least one day",
    timeOfDayLabel: "Time of day",
    timeOfDay: ["Morning", "Afternoon", "Evening", "Any"],
    timeframeLabel: "Starting when? (optional)",
    timeframePlaceholder: "e.g. from May",
    ideaLabel: "Your idea",
    ideaPlaceholder: "Motif, style, details — briefly.",
    referenceLabel: "Link to inspiration images (optional)",
    styleLabel: "Style",
    stylePlaceholder: "Choose a style",
    sizeLabel: "Approximate size",
    sizePlaceholder: "approx. 15 x 20 cm",
    placementLabel: "Body area",
    placementPlaceholder: "e.g. inner forearm, right",
    placementHint: "Describe the spot as precisely as possible — a photo helps a lot.",
    photoLabel: "Photo of the spot (optional)",
    photoHint: "JPG or PNG, max 5 MB. Only visible to us.",
    photoChoose: "Choose photo",
    photoRemove: "Remove",
    photoTooLarge: "This photo is too large (max 5 MB).",
    photoInvalid: "Please select an image.",
    photoError: "Photo could not be uploaded.",
    contactTitle: "Contact",
    confirmationNote: "After sending you will receive a confirmation email.",
    successTitle: "Request sent!",
    successText: "We will get back to you by email with a proposed date.",
